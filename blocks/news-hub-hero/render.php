<?php
/**
 * News Hub Hero block — render.php.
 *
 * Attributes:
 *   heading     string  Hub page H1 — first word white, remainder orange.
 *   description string  Optional intro paragraph beneath the heading.
 *
...
$heading = esc_html($attributes['heading'] ?? 'Industry News');
