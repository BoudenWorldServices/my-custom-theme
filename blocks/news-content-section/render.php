<?php
/**
 * News – Content Section block — render.php.
 *
 * Full-width variant of the case-study content section.
 * No max-width cap on the text column so body copy fills the
 * full content container on all screen sizes.
 *
 * Attributes:
            ...
            <div class="flex flex-col gap-8 lg:flex-row lg:items-start lg:gap-[60px] <?php echo $image_position === 'left' ? 'lg:flex-row-reverse' : ''; ?>">
                ...
                <div class="w-full lg:flex-1">
                    ...
                    <?php foreach ($body_paras as $para) : ?>
                        <p class="mt-6 font-roboto text-[16px] font-normal leading-[26px] text-[#364153] lg:text-[17px] lg:leading-[28px]">
