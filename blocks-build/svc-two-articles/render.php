...
$layout = $attributes['layout'] ?? 'flex';
$tick = get_theme_file_uri('assets/images/icons/Icon-1.svg');

$is_grid = ($layout === 'grid');
$container_class = $is_grid
    ? 'mt-12 grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-12'
    : 'flex flex-col gap-10 lg:flex-row lg:gap-[74px]';
$h2_class = $is_grid
    ? 'font-montserrat text-[36px] font-bold leading-[40px] text-[#020202]'
    : 'font-montserrat text-[32px] font-bold leading-[40px] text-[#020202] lg:text-[36px]';
?>
<section class="w-full bg-white">
    <div class="mx-auto w-full max-w-[1440px] px-5 py-12 sm:px-6 lg:px-[68px] lg:py-[80px]">
        <?php if ($intro) : ?>
            <p class="font-montserrat text-[16px] font-medium leading-[24px] text-[#364153]"><?php echo $intro; ?></p>
        <?php endif; ?>
        ...
        <div class="<?php echo $container_class; ?>">
            <article class="w-full">
                ...
                <?php endif; ?>
                <?php if ($a1_h) : ?>
                    <h2 class="<?php echo $a1_icon ? 'mt-6 ' : ''; ?><?php echo $h2_class; ?>"><?php echo $a1_h; ?></h2>
                <?php endif; ?>
                <div class="mt-6 font-montserrat text-[16px] font-medium leading-[24px] text-[#364153]">
                    ...
                    <?php endforeach; ?>
                    <?php if ($a1_bold) : ?>
                        <p class="mt-<?php echo empty($a1_paras) ? '0' : '2'; ?> font-montserrat text-[16px] font-bold leading-[23px] text-[#020202]"><?php echo $a1_bold; ?></p>
                    <?php endif; ?>
                </div>
                <?php if ($a1_sub) : ?>
            ...
            <article class="w-full">
                ...
                <?php endif; ?>
                <?php if ($a2_h) : ?>
                    <h2 class="<?php echo $a2_icon ? 'mt-6 ' : ''; ?><?php echo $h2_class; ?>"><?php echo $a2_h; ?></h2>
                <?php endif; ?>
                <div class="mt-6 font-montserrat text-[16px] font-medium leading-[24px] text-[#364153]">
