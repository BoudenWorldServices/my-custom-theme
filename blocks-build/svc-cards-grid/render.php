...
<section class="w-full bg-white">
    <div class="mx-auto w-full max-w-[1440px] px-5 py-12 sm:px-6 lg:px-[68px] <?php echo $py_class; ?>">
        <?php if ($heading) : ?>
            <h2 class="max-w-[896px] font-montserrat text-[32px] font-bold leading-[40px] text-[#020202] lg:text-[36px]"><?php echo $heading; ?></h2>
        <?php endif; ?>

        <?php foreach ($intro as $i => $p) : ?>
            <p class="mt-<?php echo $i === 0 ? $intro_spacing : '6'; ?> max-w-[896px] font-roboto text-[18px] leading-[28px] text-[#364153]"><?php echo esc_html($p); ?></p>
        <?php endforeach; ?>
